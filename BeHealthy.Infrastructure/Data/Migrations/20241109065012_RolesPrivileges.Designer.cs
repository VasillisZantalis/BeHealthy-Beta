...
namespace BeHealthy.Migrations
{
    ...
    [Migration("20241109065012_RolesPrivileges")]
    partial class RolesPrivileges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeHealthy.Shared.Models.Entities.AppSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("InsDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 11, 9, 6, 50, 12, 309, DateTimeKind.Utc).AddTicks(3581));
            ...
            modelBuilder.Entity("BeHealthy.Shared.Models.Entities.Privilege", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeHealthy.Shared.Models.Entities.RolePrivilege", b =>
                {
            ...
            modelBuilder.Entity("BeHealthy.Shared.Models.Entities.Department", b =>
                {
                    b.HasOne("BeHealthy.Shared.Models.Entities.Doctor", "HeadOfDepartment")
                        .WithMany()
            ...
            modelBuilder.Entity("BeHealthy.Shared.Models.Entities.RolePrivilege", b =>
                {
                    b.HasOne("BeHealthy.Shared.Models.Entities.Privilege", "Privilege")
