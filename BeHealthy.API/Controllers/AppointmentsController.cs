...
public class AppointmentsController(IAppointmentService appointmentService) : ApiControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType<PaginatedResult<AppointmentDto>>(StatusCodes.Status200OK)]
    public async Task<ActionResult<PaginatedResult<AppointmentDto>>> GetAll([FromQuery] AppointmentQueryParameters parameters)
